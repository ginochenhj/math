...
\]
%******************************************************************************
% Decomposição de QR via Householder
%******************************************************************************
...
&A = \left[\begin{array}{rrr}
	...
	0,1 & 0,7 & 0,3\\
	0,1 & 0,1 & 0,6
\end{array}\right] \lambda_1 = 0,6 u_1 = 
	\left[\begin{array}{r}
		 1\\
		-1\\
		 0
	\end{array}\right] \text{ normalizado: } v_1 = 
	\frac{\sqrt{2}}{2}\left[\begin{array}{r}
		 1\\
		-1\\
		 0
	\end{array}\right] , \lambda_2 = 1, \lambda_3 = 0,5 &&\\
&Q_1 = [ \, v_1 \, w_2 \, w_3 ], w_2, w_3, \text{abritrários para que } Q_1 \text{ seja unitário } 
	...
	\end{array}\right]
\\
&Q_1^HAQ_1 = \left[\begin{array}{rrr}
		0,6 &         0,1 & -0,1\sqrt{2} \\
		  0 &         0,9 & 0,2\sqrt{2} \\
		  0 & 0,1\sqrt{2} & 0,6
	\end{array}\right] 
	A_1 = \left[\begin{array}{rr}
		        0,9 & 0,2\sqrt{2} \\
		0,1\sqrt{2} & 0,6
	\end{array}\right] \lambda_2 = 1 \text{ normalizado: } 
	v_2 = \left[\begin{array}{c}
		\frac{2\sqrt{2}}{3}\\
		\frac{1}{3}
	\end{array}\right] \\
&Q_2 = [ \, v_2 \, w_2 ], w_2, \text{abritrários para que } Q_2 \text{ seja unitário } 
	...
	\end{array}\right]
\\
&Q_2^HQ_1^HAQ_1Q_2 = \left[\begin{array}{rrr}
		0,6 & \frac{0,1 \sqrt{2}}{3} &  \frac{1}{6} \\
		  0 &                      1 & -0,1\sqrt{2} \\
		  0 &                      0 &          0,5
	\end{array}\right] 
\end{flalign*}
...
&A = \left[\begin{array}{rr}
	...
	2 & 2
\end{array}\right] 
A^HA = \left[\begin{array}{rr}
	9 & 9\\
	9 & 9
\end{array}\right] \text{tem autovalores } 18, 0 \text{ Valores singulares } \sigma_1 = \sqrt{18} = 3\sqrt{2}.&&\\
&\text{ Autovetores de } A^HA \text{ são: }
v_1 = \frac{1}{\sqrt{2}}\left[\begin{array}{r}
	1\\
	1
\end{array}\right],
v_2 = \frac{1}{\sqrt{2}}\left[\begin{array}{r}
	1\\
	-1
\end{array}\right] \text{ e } V = [v_1 \, v_2 ]\\
&AA^H = \left[\begin{array}{rrr}
	2 & 4 & 4\\
	4 & 8 & 8\\
	4 & 8 & 8
\end{array}\right] \text{tem autovalores } 18, 0, 0\\
&\text{ Autovetores de } AA^H \text{são: }
u_1 = \frac{1}{3}\left[\begin{array}{r}
	1\\
	2\\
	2
\end{array}\right],
u_2 = \frac{1}{\sqrt{5}}\left[\begin{array}{r}
	-2\\
	 1\\
	 0
\end{array}\right],
u_3 = \frac{\sqrt{5}}{15}\left[\begin{array}{r}
	 2\\
	 4\\
	-5
\end{array}\right] \text{ e } U = [u_1 \, u_2 \, u_3 ]\\
&\Sigma = U^HAV = \left[\begin{array}{rrr}
	         \frac{1}{3} &          \frac{2}{3} &           \frac{2}{3}\\
	 -\frac{2}{\sqrt{5}} &   \frac{1}{\sqrt{5}} &                     0\\
	\frac{2\sqrt{5}}{15} & \frac{4\sqrt{5}}{15} & -\frac{5\sqrt{5}}{15}
\end{array}\right]
 \left[\begin{array}{rr}
	1 & 1\\
	2 & 2\\
